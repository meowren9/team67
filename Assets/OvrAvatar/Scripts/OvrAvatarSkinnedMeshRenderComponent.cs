...
public class OvrAvatarSkinnedMeshRenderComponent : OvrAvatarRenderComponent
{
    ...
    {
        this.surfaceSelfOccluding = surfaceSelfOccluding != null ? surfaceSelfOccluding :  Shader.Find("Custom/HandShader");
        this.surface = surface != null ? surface : Shader.Find("Custom/HandShader");
